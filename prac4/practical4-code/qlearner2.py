...
class QLearner2(QLearner):
  '''
  Implements a more intelligent Q-Learning Mechanism
  '''
  def __init__(self, k = 0.5, x0 = 1 ,bucket_height = 17, bucket_width = 83, velocity_bucket = 17):
    ...
    super(QLearner2,self).__init__(bucket_width = bucket_width, bucket_height = bucket_height, velocity_bucket= velocity_bucket)
