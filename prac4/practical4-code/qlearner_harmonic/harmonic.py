...
from qlearner3 import QLearner3 as QLearner
...
def branin(learn, greedy, buckets_w, buckets_h, buckets_v):
    def run_game():
    ...
    learner_class = QLearner(lscale = learn,
                             escale = greedy,
